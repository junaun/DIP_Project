...
class ConstantProvider with ChangeNotifier {
  List<User> allUsers = <User>[
    ...
    User(quantity: 'electron charge', value: '-1.602*10^{-19}', unit: 'C'),
    User(
        quantity: 'electron rest mass',
        value: '9.109 x 10^{-31}',
        unit: 'electron'),
    User(quantity: "planck's constant", value: '6.626*10^{-34}', unit: 'J/s'),
    User(quantity: 'atomic mass constant', value: '1.66*10^{-27}', unit: 'kg'),
    User(
